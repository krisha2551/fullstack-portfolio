...
const About = () => {
  ...
  const handleDownload = () => {
    ...
    link.download = "Krisha_Jasani_Resume.pdf";
    link.click();
  };
        ...
        >
          ...
          <motion.div variants={fadeUp} className="relative pl-6">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              BCA graduate and Full-Stack Developer trained at
              <span className="text-[#27CBCB]">
                {" "}Red & White Skill Education, Bhavnagar
              </span>, passionate about building modern web applications using the MERN
              stack, solving real-world problems, and continuously improving through
          ...
          >
            <p className="text-[#80978F] text-sm sm:text-base leading-relaxed italic">
              &quot;Driven by curiosity and a passion for technology, I enjoy turning ideas
              into <span className="text-gray-300">practical web applications</span> while
