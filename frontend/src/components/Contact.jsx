      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <motion.div variants={fade} initial="hidden" whileInView="show">
          ...
          <p className="mt-6 text-gray-400 max-w-md text-lg">
           Interested in collaborating, discussing opportunities, or connecting? 
           Feel free to send a message and I’ll get back to you soon.
          </p>
          ...
          <div className="mt-10 space-y-4">
            ...
            <motion.a
              whileHover={{ x: 6 }}
              href="https://www.linkedin.com/in/krishajasani/"
              target="_blank"
              className="flex items-center gap-4 p-4 rounded-xl border border-gray-800 bg-gray-900/40 backdrop-blur-sm"
            >
        ...
        >
          ...
          <div>
            <input
              ...
              className="w-full p-3 rounded-lg bg-gray-900 border border-gray-800 focus:border-emerald-500 focus:outline-none"
            />
            {errors.name && (
          ...
          <div>
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              className="w-full p-3 rounded-lg bg-gray-900 border border-gray-800 focus:border-emerald-500 focus:outline-none resize-none"
            />
            {errors.message && (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-emerald-600 hover:bg-emerald-700 font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
